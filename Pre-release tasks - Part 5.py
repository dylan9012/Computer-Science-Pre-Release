...
def DisplayErrorCode(ErrorNumber):
  if ErrorNumber == 1:
    print('Error ', ErrorNumber,": Piece is not on board")
  if ErrorNumber == 2:
    print('Error ' , ErrorNumber,": Move with selected piece is not possible")
  if ErrorNumber == 3:
    print('Error ' , ErrorNumber, ": Piece is not able to move")
  if ErrorNumber == 4:
    print('Error ' , ErrorNumber, ": File not found")
...
def MakeMove(Board, PlayersPieces, OpponentsPieces, ListOfMoves, PieceIndex):
  ...
  if PieceIndex > 0:
    ...
    print("Number of moves: ",PlayersPieces[0][0])
